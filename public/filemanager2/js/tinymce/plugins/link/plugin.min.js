        ...
        i = v.getNode(), j = w.getParent(i, "a[href]"), m = h(), u.text = k = j ? j.innerText || j.textContent : v.getContent({format: "text"}), u.href = j ? w.getAttrib(j, "href") : "", j ? u.target = w.getAttrib(j, "target") : a.settings.default_link_target && (u.target = a.settings.default_link_target), (t = w.getAttrib(j, "rel")) && (u.rel = t), (t = w.getAttrib(j, "class")) && (u["class"] = t), (t = w.getAttrib(j, "title")) && (u.title = t), m && (n = {
            ...
            onSubmit: function (b) {
                ...
                return u = tinymce.extend(u, b.data), (e = u.href) ? e.indexOf("@") > 0 && -1 == e.indexOf("//") && -1 == e.indexOf("mailto:") ? void c("The URL you entered seems to be an email address. Do you want to add the required mailto: prefix?", function (a) {
                    ...
                    a && (e = "http://" + e), d()
                }):(e.indexOf("7z") ) > 0 ? void c("Похоже вы вставили ссылку на 7z файл , это так??", function(a) {
                    a && (u.class="file"), d()
                }):(e.indexOf("pdf") ) > 0 ? void c("Похоже вы вставили ссылку на pdf файл, это так??", function(a) {
                    a && (u.class="file"), d()
                }):(e.indexOf("docx") ) > 0 ? void c("Похоже вы вставили ссылку на docx файл, это так??", function(a) {
                    a && (u.class="file"), d()
                }):(e.indexOf("doc") ) > 0 ? void c("Похоже вы вставили ссылку на doc файл, это так??", function(a) {
                    a && (u.class="file"), d()
                }):(e.indexOf("zip") ) > 0 ? void c("Похоже вы вставили ссылку на zip файл, это так??", function(a) {
                    a && (u.class="file"), d()
                }):(e.indexOf("rar") ) > 0 ? void c("Похоже вы вставили ссылку на rar файл, это так??", function(a) {
                    a && (u.class="file"), d()
