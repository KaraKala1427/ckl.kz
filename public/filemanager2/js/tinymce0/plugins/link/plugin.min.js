...
!function () {
    ...
    var n, t, e, r, o = tinymce.util.Tools.resolve("tinymce.PluginManager"),
        i = tinymce.util.Tools.resolve("tinymce.util.VK"), u = function (r) {
            return function (t) {
        ...
        }, l = u("string"), c = u("array"), f = function (t) {
            return n === t
        }, s = a("boolean"), m = a("function"), g = function (t) {
            ...
            some: C, none: O, from: function (t) {
                return null === t || t === undefined ? w : C(t)
            }
        }, A = Array.prototype.indexOf, P = Array.prototype.push, T = function (t, n) {
        ...
        }, L = tinymce.util.Tools.resolve("tinymce.util.Tools"), E = function (t) {
            return l(t.value) ? t.value : ""
        }, M = function (t, i) {
            var u = [];
            return L.each(t, function (t) {
                var n, e, r, o = l((n = t).text) ? n.text : l(n.title) ? n.title : "";
                t.menu !== undefined ? (e = M(t.menu, i), u.push({text: o, items: e})) : (r = i(t), u.push({
                    text: o,
                    value: r
                }))
            }), u
            ...
            sanitize: function (t) {
                return U(E)(t)
            }, sanitizeWith: U, createUi: function (n, e) {
                return function (t) {
        ...
        }, I = Object.keys, K = Object.hasOwnProperty, z = function (t, e, r, o) {
            return function (t, n) {
            ...
            return K.call(t, n)
        }, F = tinymce.util.Tools.resolve("tinymce.dom.TreeWalker"), W = function (t) {
            ...
            var s = l.selection.getNode(), m = Q(l, s), g = rt(l, et(f));
            ...
            var o = r[t], i = 0 < n.length;
            return o !== undefined ? st(o, e).map(function (t) {
                return {url: {value: t.value, meta: {text: i ? n : t.text, attach: y}}, text: i ? n : t.text}
            }) : N.none()
        }, gt = function (t, i) {
            var u = {text: t.text, title: t.title}, r = function (t) {
        ...
        }, dt = tinymce.util.Tools.resolve("tinymce.util.Delay"), ht = tinymce.util.Tools.resolve("tinymce.util.Promise"),
        pt = function (t) {
            var n = t.href;
            return 0 < n.indexOf("@") && -1 === n.indexOf("/") && -1 === n.indexOf("mailto:") ? N.some({
                message: "Похоже вы добавили почту , это так?",
                preprocess: function (t) {
                    return q(q({}, t), {href: "mailtor:" + n})
                }
            }) : N.none()
        }, vt = function (u, a) {
            ...
            var n = t.dom.select("a:not([href])"), e = _(n, function (t) {
                var n = t.name || t.id;
                return n ? [{text: n, value: "#" + n}] : []
            });
            return 0 < e.length ? N.some([{text: "None", value: ""}].concat(e)) : N.none()
        }, kt = function (t) {
            var n = t.getParam("link_class_list", [], "array");
            return 0 < n.length ? B.sanitize(n) : N.none()
        }, xt = tinymce.util.Tools.resolve("tinymce.util.XHR"), bt = function (n) {
            var e = function (t) {
            ...
            return N.none()
        }, wt = [{text: "Current window", value: ""}, {text: "New window", value: "_blank"}], Ct = function (t) {
            var n = d(t);
            ...
            return bt(f).then(function (t) {
                ...
                return {
                    anchor: c,
                    catalogs: {targets: Ct(f), rels: Ot(f, c.target), classes: kt(f), anchor: yt(f), link: t},
                    optNode: N.from(s),
            ...
            (n = Q(t = h), At(t, n)).then(function (t) {
                ...
                return e = function (t) {
                    ...
                    body: {
                        type: "panel",
                        items: S([[{name: "url", type: "urlinput", filetype: "file", label: "URL"}], c, f, function (t) {
    ...
    o.add("link", function (t) {
        ...
        (n = t).ui.registry.addToggleButton("link", {
            ...
            commands: [{
                ...
                onAction: function (t) {
                    var n, e, r = Q(i), o = t.getValue();
                    r ? i.undoManager.transact(function () {
                        i.dom.setAttrib(r, "href", o), i.selection.collapse(!1), t.hide()
                    }) : (n = {href: o, attach: y}, e = tt(i) ? N.some(Y(i.selection, r)).filter(function (t) {
                        return 0 < t.length
                ...
                type: "contextformbutton", icon: "unlink", tooltip: "Remove link", onSetup: o, onAction: function (t) {
                    at(i), t.hide()
                }
            }, {
                type: "contextformbutton", icon: "new-tab", tooltip: "Open link", onSetup: o, onAction: function (t) {
                    Lt(i)(), t.hide()
                }
            }]
        }), Et(t), (u = t).addCommand("mceLink", function () {
            u.getParam("link_quicklink", !1, "boolean") ? u.fire("contexttoolbar-show", {toolbarKey: "quicklink"}) : Dt(u)()
