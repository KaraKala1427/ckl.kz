            ...
            <form action="#" method="" id="call-popup">
                <div class="grid">
                    ...
                    <fieldset class="field-set col col--full" style="">
                        ...
                        <strong><small id="fullname_error1" class="form-text text-" style="display: none;  color: crimson">Вы не указали как вас зовут</small></strong>
                    </fieldset>
                    ...
                    <fieldset class="field-set col col--1-2" style="">
                        ...
                        <strong> <small id="phone_error1" class="form-text text-" style="display: none; color: crimson">Вы не указали телефон</small></strong>
                    </fieldset>
