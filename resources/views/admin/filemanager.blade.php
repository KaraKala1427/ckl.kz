...
<header>
    <h2 class="app_title"><img src="{{asset('filemanager/img/logo.png')}}"
                               alt=""><span>Файловый менеджер</span></h2>
    ...
    <div class="right">
        ...
        <div class="search_box">
            <input type="text" placeholder="Поиск" ng-model="q"
...
<div class="wrapper">
    <div class="sidebar">
        ...
        <div class="upload_section" ng-hide="previewOpen">
            ...
            <p class="upload_title">Загрузить</p>
    ...
    <div class="content">
        <div class="gallery">
            ...
            <div class="gl_item gl_header">
                ...
                <div class="modified">Изменен</div>
...
<script>
    ...
    filemanager.controller('FilemanagerCtrl', function ($scope, $http, $q, $window, $timeout) {
        ...
        var defaultOptions = {
            ...
            dictDefaultMessage: "Нажмите сюда чтобы загрузить",
