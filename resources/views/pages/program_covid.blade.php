...
@section('content')
    @if(App::getLocale()  === 'ru')
        <table class="table table-bordered covid-program">
            <tr>
                <th colspan="5" class="font-weight-bolder">Условия страхования ненакопительного (срочного) страхования
                    жизни
            ...
            <tr>
                <td colspan="3" style="border: none">4. Период действия страховой защиты начинается по истечении 7
                    (семи)
    ...
    @else
        ...
        @include('mini_parts.program_covid_kz')
